...
var _ledOn = Module['_ledOn'] = makeInvalidEarlyAccess('_ledOn');
var _ledOff = Module['_ledOff'] = makeInvalidEarlyAccess('_ledOff');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['ledOn'] != 'undefined', 'missing Wasm export: ledOn');
  assert(typeof wasmExports['ledOff'] != 'undefined', 'missing Wasm export: ledOff');
  ...
  _ledOn = Module['_ledOn'] = createExportWrapper('ledOn', 0);
  _ledOff = Module['_ledOff'] = createExportWrapper('ledOff', 0);
